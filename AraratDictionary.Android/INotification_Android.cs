...
[assembly: Dependency(typeof(INotification_Android))]
namespace AraratDictionary.Droid
{
    public class INotification_Android : INotification
    {
        private Context mContext;
        private NotificationCompat.Builder mBuilder;
        public static String NOTIFICATION_CHANNEL_ID = "10023";

        public INotification_Android()
        {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                mBuilder.SetSmallIcon(Resource.Drawable.logo_main);
                mBuilder.SetContentTitle(title)
                        ...
                        .SetSmallIcon(Resource.Drawable.logo_main)
